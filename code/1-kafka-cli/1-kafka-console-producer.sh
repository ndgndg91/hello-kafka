...
kafka-topics --bootstrap-server localhost:9092 --topic first-topic --create --partitions 1
...
kafka-console-producer --bootstrap-server localhost:9092 --topic new-topic
> hello world!

# our new topic only has 1 partition
kafka-topics --bootstrap-server localhost:9092 --list
kafka-topics --bootstrap-server localhost:9092 --topic new-topic --describe
...
kafka-console-producer --bootstrap-server localhost:9092 --topic new-topic-2
hello again!

# this time our topic has 3 partitions
kafka-topics --bootstrap-server localhost:9092 --list
kafka-topics --bootstrap-server localhost:9092 --topic new-topic-2 --describe
